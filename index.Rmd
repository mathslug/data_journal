...
[**News Bits**](./index.html) is currently a random website without even a real url that currently adds no value to anything. Here's the [Github repo](https://github.com/mathslug/data_journal)

## Latest Articles

Currently most of these are just random links to my blog as placeholders
